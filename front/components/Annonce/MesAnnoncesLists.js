...
const MesAnnoncesLists = ({
    ...
    return (
        <>
            <div className="premium-myannonce-block w-12/12 md:w-6/12 lg:w-6/12 md:px-4 -mt-32 pt-6">
                <h4 className="text-orange-500 text-center text-2xl">Votre annonce premium</h4>
                {cars?.map((car, idx) => car?.premium == true &&
                    (
                            ...
                            <div className="favoris-block flex-wrap">
                                ...
                                <span
                                    ...
                                    <div className="top justify-between">
                                      <div className="font-bold text-xl uppercase text-orange-700 text-center m-2">
                                  ...
                                  <div className="flex flex-wrap">
                                        <div className="w-1/3">
                                          <span
                                              className="text-sm block p-3 text-gray-800 rounded border border-solid border-gray-200"><i
                                    ...
                                    <div className="button-block justify-left">
                                        <button
                                            className="bg-gray-800 text-white active:bg-gray-700 text-xs font-bold uppercase py-2 mr-2 rounded shadow hover:shadow-lg outline-none focus:outline-none ease-linear transition-all duration-150"
                                            type="button"
                                        >
                                        ...
                                        {isAuthentificated && car?.premium === true ? (
                                            <button
                                                className="bg-orange-500 text-white active:bg-gray-700 text-xs font-bold uppercase py-2 mr-2 rounded shadow hover:shadow-lg outline-none focus:outline-none ease-linear transition-all duration-150"
                                                type="button"
                                            >
                                                <Link href="/vendre">
                                                    <a
            ...
            <div className="classic-myannonce-block w-12/12 md:w-6/12 lg:w-6/12 md:px-4 -mt-32 pt-6">
                <h4 className="text-gray-700 text-center text-2xl">Votre annonce classic</h4>
                {cars?.map((car, idx) => car?.premium == false &&
                    (
                        <div key={`car_${car.id}`} id={`car_${car.id}`} className="container px-4 mx-auto my-4">
                            <div className="favoris-block flex-wrap">
                                {car.uploads.length > 0 ? (
